...
selectInput(inputId = "sampleChar", 
            label = h5("Choose characteristic"), 
            choices = c("dose", "time", "tissue", "strain", "gender", "cell line", "development stage", "age", "agent", "cell type", "infection", "isolate", "metabolism", "shock", "stress", "temperature", "specimen", "disease state", "protocol", "growth protocol", "genotype/variation", "species", "individual", "other"), 
            selectize = T)

# Condition if other is selected
conditionalPanel(condition = "input.sampleChar == 'other'",
                 textInput(inputId = "other", 
                           value = "", 
                           label = h5("Other variable name"))
                 )
