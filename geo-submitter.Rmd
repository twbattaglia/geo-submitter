...
textInput(inputId = "organism", 
          label = p("Identify the organism(s) from which the biological material was derived. See", a("NCBI Taxonomy", href="http://www.ncbi.nlm.nih.gov/Taxonomy/taxonomyhome.html/", target="_blank"), " for a listing."),
          value = "",
          width = "400px",
...
textInput(inputId = "platform", 
          label = p("Enter the NCBI platform identifier used.", a("See", href = "http://www.ncbi.nlm.nih.gov/geo/browse/?view=platforms&tool=findplatform", target="_blank"), "to find the corresponding identifier."), 
          value = "", 
          width = "400px",
...
```{r help export}
h4("Help")
p("Review the", tags$b("Experimental data"), "and", tags$b("Sample data"), "tables to be sure the information you have inputed is correct. Once the experimental and sample metadata are valid, export all information as a SOFT file. The SOFT file will be required for data submission on GEO's SOFT submission website.")
...
h5("Step 2. Compress folder.")
img(src = "www/compress_folder.png", width = NULL)

tags$hr()

h5("Step 3. Submit compressed archive.")
a("GEO-SOFT submission page", href = "http://www.ncbi.nlm.nih.gov/geo/submission/depslip.cgi", target="_blank")
