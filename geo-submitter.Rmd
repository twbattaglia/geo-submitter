...
selectInput(inputId = 'data_type', 
            label = helpText("Help text with eventually go here."), 
...
output$geneNumber <- renderValueBox({
  ...
  valueBox(geneN,caption = "Number of genes", icon = "fa-cubes")
})
...
output$sampleNumber <- renderValueBox({
  ...
  valueBox(sampleN, caption = "Number of samples", icon = "fa-users")
})
...
observeEvent(input$addAuthor, {
  ...
  if(is.na(input$firstName) | is.na(input$lastName)){
